...
NDiplomacy = {
	...
	TENSION_TIME_SCALE_START_DATE = "2022.1.1.1",	-- Starting at this date, the tension values will be scaled down (will be equal to 1 before that)
...
REINFORCEMENT_MANPOWER_CHUNK = 0.1,				-- Chunk size of manpower reinforcement delivery, in % of total manpower needed by the template.
	...
	BASE_MAX_COMMAND_POWER = 400,					-- base value for maximum command power
	BASE_COMMAND_POWER_GAIN = 2,					-- base value for daily command power gain
...
NPolitics = {
	...
	BASE_POLITICAL_POWER_INCREASE = 5,	-- Weekly increase of PP.
...
-----------------------------
	...
	INFRASTRUCTURE_MOVEMENT_SPEED_IMPACT = -0.10,	-- Lancaster шакал vanila 0.5 speed penalty per infrastucture below maximum.
	...
	UNIT_EXP_LEVELS = { 0.1, 0.3, 0.6, 0.8 },		-- Experience needed to progress to the next level
	...
	FUEL_FLOW_PENALTY_FOR_SUPPLY_CHUNK_EDGE_RATIO = 0.5, -- поток питания, ограниченный контролем входящих краевых провинций, будет иметь меньшее влияние на поток топлива
...
NAir = {
	...
	AA_INDUSTRY_AIR_DAMAGE_FACTOR = -0.05,				-- 5x levels = 60% defense from bombing
...
NAI = {
	...
	EVAL_MODIFIER_MAX_COMMAND_POWER_FACTOR = 0.02,                -- Increasing CP cap with x is maybe 100 times less useful than e.g. gaining x more XP per day
	...
	LAND_DEFENSE_AA_IMPORTANCE_FACTOR = 0.7,			-- Factor of AA influence on strategic importance ( 0.0 - 1.0 )
	...
	STR_BOMB_AA_IMPORTANCE_FACTOR = 0.25,				-- Factor of AA influence on strategic importance ( 0.0 - 1.0 )
...
NSupply = {
	...
	SUPPLY_FLOW_PENALTY_CROSSING_RIVERS = 0.40, -- #was 0.20 crossing rivers introduces additional penalty
